...
test('SourceWrappersContainer', () => {
    ...
    expect(sourceMainWrappers[0].props()['fsLightboxIndex']).toBe(1);
    expect(sourceMainWrappers[0].props()['i']).toBe(0);
    expect(sourceMainWrappers[1].props()['fsLightboxIndex']).toBe(1);
    expect(sourceMainWrappers[1].props()['i']).toBe(1);
    expect(sourceMainWrappers[2].props()['fsLightboxIndex']).toBe(1);
    expect(sourceMainWrappers[2].props()['i']).toBe(2);
    expect(sourceMainWrappers[3].props()['fsLightboxIndex']).toBe(1);
    expect(sourceMainWrappers[3].props()['i']).toBe(3);
});
