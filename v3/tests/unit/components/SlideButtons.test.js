...
test('SlideButtons', () => {
    ...
    expect(slideButtonsChildren[0].props()['onClick']).toBe(fsLightboxStore[2].core.slideChangeFacade.changeToPrevious);
    expect(slideButtonsChildren[1].props()['onClick']).toBe(fsLightboxStore[2].core.slideChangeFacade.changeToNext);
});
