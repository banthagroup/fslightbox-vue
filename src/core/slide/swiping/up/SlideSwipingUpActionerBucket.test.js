...
beforeEach(() => {
    ...
    fsLightbox.elements.sourcesOuters[0] = { classList: { add: jest.fn() } };
    fsLightbox.elements.sourcesOuters[1] = { classList: { add: jest.fn() } };
    fsLightbox.elements.sourcesOuters[2] = { classList: { add: jest.fn() } };
});
...
test('runPositiveSwipedXActions', () => {
    ...
    expect(fsLightbox.elements.sourcesOuters[0].classList.add).not.toBeCalled();
    expect(fsLightbox.elements.sourcesOuters[1].classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
    ...
    expect(fsLightbox.elements.sourcesOuters[0].classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
    expect(fsLightbox.elements.sourcesOuters[1].classList.add)
...
test('runNegativeSwipedXActions', () => {
    ...
    expect(fsLightbox.core.slideIndexChanger.changeTo).not.toBeCalled();
    expect(fsLightbox.elements.sourcesOuters[1].classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
    expect(fsLightbox.elements.sourcesOuters[2].classList.add).not.toBeCalled();
    expect(fsLightbox.collections.sourcesOutersTransformers[1].zero).toBeCalled();
    ...
    expect(fsLightbox.elements.sourcesOuters[1].classList.add)
        .toHaveBeenNthCalledWith(2, TRANSFORM_TRANSITION_CLASS_NAME);
    expect(fsLightbox.elements.sourcesOuters[2].classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
